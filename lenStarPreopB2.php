...
echo "Logging in Success...\n";
    ...
    if ($res->num_rows>0) {  // found a record
		...
		$sqlPatInsert = "INSERT INTO patients (LastName,FirstName,MI,BirthDate,ChartID,Ethnicity,Sex,dbowner) values (cast(hex(DES_ENCRYPT( '".
						...
						$Ethnicity."','".$Sex."',".$_SESSION['OwnerID'].")";
